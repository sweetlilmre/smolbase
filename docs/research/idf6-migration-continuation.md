...
**Both former cautions are retired (2026-08-30).** The temporary instrumentation is fully removed — SDK tree, `src/core/`, and the v0.3.3 worktree are all pristine — and the bench is back: see *Bench state* below.
