...
- [Incremental filesystem updates over GitHub OTA (#121)](https://github.com/sweetlilmre/smolbase/issues/121) — complete (PR #125 pending merge): staged-tar asset updates verified on-device incl. rollback restore; settings survive.
