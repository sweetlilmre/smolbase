...
- [OTA self-update from GitHub releases (#106)](https://github.com/sweetlilmre/smolbase/issues/106) — complete: firmware-only initially; finished off by maps #112/#121 (closed 2026-08-21).
...
- [Incremental filesystem updates over GitHub OTA (#121)](https://github.com/sweetlilmre/smolbase/issues/121) — complete (merged via PR #125): staged-tar asset updates verified on-device incl. rollback restore; settings survive.
